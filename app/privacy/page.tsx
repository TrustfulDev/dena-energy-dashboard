...
export default async function Privacy() {
        return (
                <div className="mx-auto p-4 lg:overflow-y-auto m-4 md:mb-6 md:mx-0 mt-0">
                    <h1 className="text-2xl font-bold mb-4">Privacy Policy</h1>
                    <p className="text-sm mb-2">Last updated April 29, 2024</p>
                    <p className="mb-4">This privacy notice for Dena Energy Inc ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:</p>
                    <ul className="list-disc pl-6 mb-4">
                        <li>Visit our website at <a href="https://energydian.com" className="text-blue-500">https://energydian.com</a>, or any website of ours that links to this privacy notice</li>
                        <li>Engage with us in other related ways, including any sales, marketing, or events</li>
                    </ul>
                    <p className="mb-4">Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@dena.energy" className="text-blue-500">info@dena.energy</a>.</p>
                    
                    {/* Summary of Key Points */}
                    <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        <h2 className="text-lg font-bold mb-2">Summary of Key Points</h2>
                        <p className="mb-2">This summary provides key points from our privacy notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our <a href="#table-of-contents" className="text-blue-500">table of contents</a> below to find the section you are looking for.</p>
                        <ul className="list-disc pl-6 mb-4">
                            <li><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about <a href="#personal-information" className="text-blue-500">personal information you disclose to us</a>.</li>
                            ...
                            <li><strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. Learn more about <a href="#information-processing" className="text-blue-500">how we process your information</a>.</li>
                            <li><strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. Learn more about <a href="#sharing-personal-information" className="text-blue-500">when and with whom we share your personal information</a>.</li>
                            <li><strong>How do we keep your information safe?</strong> We have organizational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about <a href="#information-security" className="text-blue-500">how we keep your information safe</a>.</li>
                            <li><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about <a href="#privacy-rights" className="text-blue-500">your privacy rights</a>.</li>
                            <li><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a <a href="#data-subject-access-request" className="text-blue-500">data subject access request</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</li>
                    ...
                    {/* Table Of Contents */}
                    <div className="border-t-2 border-gray-300 pt-4 mt-4" id="table-of-contents">
                    ...
                    <div className="border-t-2 border-gray-300 pt-4 mt-4" id="personal-information">
                        <h2 className="text-lg font-bold mb-2">1. What Information Do We Collect?</h2>
                ...
                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        ...
                        <li><strong>When we use Google Analytics.</strong> We may share your information with Google Analytics to track and analyze the use of the Services. To opt out of being tracked by Google Analytics across the Services, visit <a href="https://tools.google.com/dlpage/gaoptout" className="text-blue-500">https://tools.google.com/dlpage/gaoptout</a>. For more information on the privacy practices of Google, please visit the Google Privacy & Terms page.</li>
                        </ul>
                </div>
                ...
                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        ...
                        <p><strong>Account Information:</strong> If you would at any time like to review or change the information in your account or terminate your account, you can:
                        <br />
                        ...
                        <p>If you have questions or comments about your privacy rights, you may email us at privacy@dena.energy.</p>
                </div>
                ...
                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        ...
                        {/* Categories of personal information list goes here */}
                        <div className="border-t-2 border-gray-300 pt-4 mt-4">
                                <h2 className="text-lg font-bold mb-2">Categories of Personal Information We Collect</h2>
                                <div className="grid grid-cols-3 gap-4">
                                <div className="border-r border-gray-300 pr-4">
                                <p className="font-bold border-b border-gray-300 pb-2">Category</p>
                                <p className="border-b border-gray-300 pb-2">A. Identifiers</p>
                                <p className="border-b border-gray-300 pb-2">B. Personal information as defined in the California Customer Records statute</p>
                                <p className="border-b border-gray-300 pb-2">C. Protected classification characteristics under state or federal law</p>
                                <p className="border-b border-gray-300 pb-2">D. Commercial information</p>
                                <p className="border-b border-gray-300 pb-2">E. Biometric information</p>
                                <p className="border-b border-gray-300 pb-2">F. Internet or other similar network activity</p>
                                <p className="border-b border-gray-300 pb-2">G. Geolocation data</p>
                                <p className="border-b border-gray-300 pb-2">H. Audio, electronic, visual, thermal, olfactory, or similar information</p>
                                <p className="border-b border-gray-300 pb-2">I. Professional or employment-related information</p>
                                <p className="border-b border-gray-300 pb-2">J. Education Information</p>
                                <p className="border-b border-gray-300 pb-2">K. Inferences drawn from collected personal information</p>
                                <p className="pb-2">L. Sensitive personal Information</p>
                                </div>
                                <div className="border-r border-gray-300 pr-4">
                                <p className="font-bold border-b border-gray-300 pb-2">Examples</p>
                                <p className="border-b border-gray-300 pb-2">A. Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</p>
                                <p className="border-b border-gray-300 pb-2">B. Name, contact information, education, employment, employment history, and financial information</p>
                                <p className="border-b border-gray-300 pb-2">C. Gender and date of birth</p>
                                <p className="border-b border-gray-300 pb-2">D. Transaction information, purchase history, financial details, and payment information</p>
                                <p className="border-b border-gray-300 pb-2">E. Fingerprints and voiceprints</p>
                                <p className="border-b border-gray-300 pb-2">F. Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</p>
                                <p className="border-b border-gray-300 pb-2">G. Device location</p>
                                <p className="border-b border-gray-300 pb-2">H. Images and audio, video or call recordings created in connection with our business activities</p>
                                <p className="border-b border-gray-300 pb-2">I. Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</p>
                                <p className="border-b border-gray-300 pb-2">J. Student records and directory information</p>
                                <p className="border-b border-gray-300 pb-2">K. Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual?s preferences and characteristics</p>
                                <p className="border-b border-gray-300 pb-2">L. N/A </p>
                                <p className="pb-2"></p>
                                </div>
                                <div>
                                <p className="font-bold border-b border-gray-300 pb-2">Collected</p>
                                <p className="border-b border-gray-300 pb-2">A. NO</p>
                                <p className="border-b border-gray-300 pb-2">B. NO</p>
                                <p className="border-b border-gray-300 pb-2">C. NO</p>
                                <p className="border-b border-gray-300 pb-2">D. NO</p>
                                <p className="border-b border-gray-300 pb-2">E. NO</p>
                                <p className="border-b border-gray-300 pb-2">F. NO</p>
                                <p className="border-b border-gray-300 pb-2">G. NO</p>
                                <p className="border-b border-gray-300 pb-2">H. NO</p>
                                <p className="border-b border-gray-300 pb-2">I. NO</p>
                                <p className="border-b border-gray-300 pb-2">J. NO</p>
                                <p className="border-b border-gray-300 pb-2">K. NO</p>
                                <p className="pb-2">L. NO</p>
                                </div>
                        </div>
                        </div>       
                </div>
                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                   ...
                   <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        <h2 className="text-lg font-bold mb-2">California Residents</h2>
                        ...
                        <h3 className="text-lg font-bold mb-2">CCPA Privacy Notice</h3>
                        ...
                        <h4 className="text-lg font-bold mb-2">Your rights with respect to your personal data</h4>
                        ...
                        <h4 className="text-lg font-bold mb-2">Other privacy rights</h4>
                        <ul className="list-disc pl-6">
                ...
                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        <h2 className="text-lg font-bold mb-2">Colorado Residents</h2>
                        ...
                        <p>To submit a request to exercise these rights described above, please email privacy@dena.energy or submit a data subject access request.</p>
                        <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at privacy@dena.energy. Within forty-five (45) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
                  </div>

                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        <h2 className="text-lg font-bold mb-2">Connecticut Residents</h2>
                ...
                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        <h2 className="text-lg font-bold mb-2">Utah Residents</h2>
                ...
                <div className="border-t-2 border-gray-300 pt-4 mt-4">
                        <h2 className="text-lg font-bold mb-2">Virginia Residents</h2>
                        <p>Under the Virginia Consumer Data Protection Act (VCDPA):</p>
                        <p><strong>"Consumer"</strong> means a natural person who is a resident of the Commonwealth acting only in an individual or household context. It does not include a natural person acting in a commercial or employment context.</p>
                        <p><strong>"Personal data"</strong> means any information that is linked or reasonably linkable to an identified or identifiable natural person. "Personal data" does not include de-identified data or publicly available information.</p>
                        <p><strong>"Sale of personal data"</strong> means the exchange of personal data for monetary consideration.</p>
                        ...
                        <h3 className="font-bold mt-4">Your rights with respect to your personal data</h3>
                        <ul className="list-disc pl-6">
                                <li>Right to be informed whether or not we are processing your personal data</li>
                                <li>Right to access your personal data</li>
                                <li>Right to correct inaccuracies in your personal data</li>
                        ...
                        <p>You may contact us by email at privacy@dena.energy or submit a data subject access request.</p>
                        ...
                        <h3 className="font-bold mt-4">Verification process</h3>
                        ...
                        <h3 className="font-bold mt-4">Right to appeal</h3>
